...
const SwaetShirt: React.FC = () => {
  ...
  return (
    <View style={[styles.container, {backgroundColor: '#ffffff'}]}>
      <Image
        source={require('../assets/sweatshirt.jpeg')}
        style={{width: imageWidth, height: 500 / 2, marginBottom: 10}}
      />
      <Text style={styles.itemName}>SweatShirt</Text>
